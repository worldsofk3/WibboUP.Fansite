    ...
    <section class="grid grid-cols-[600px_300px] gap-5 sm:w-2/3 mx-auto">
            ...
            <div class="col-span-1 max-w[600px]">
                ...
                <div class="mb-5 rounded-md flex items-center justify-evenly overflow-hidden bg-[url('https://images.habbo.com/c_images/catalogue/feature_cata_hort_scifi17bun1.png')] w-[600px] h-[160px]">
                    ...
                    <div class="text-white bg-[#22222280] w-[374px] h-[148px] p-3 rounded-md">
                        <p class="text-3xl">Jason</p>
                        <div class="flex items-center">
                            <img class="w-[15px] h-[15px] mr-1" src="@/assets/imgs/mottohome.gif" />
                            <p class="overflow-auto">Développeur de WibboUp !</p>
                        </div>
                    </div>
                </div>
            

                        <div class="bg-[url('@/assets/imgs/index/news.png')] min-h-[250px] mb-5 rounded-md flex flex-col justify-evenly p-10">
                            <h4 class="text-xl font-bold text-white">Version bêta</h4>
                            <p class="text-white max-w-[300px]">
                                Notre version bêta débarque et reste temporaire le temps du
                                développement.
                            </p>
                            <a href="#"><button type="button" class="text-[#3c3c3c] bg-white p-[5px] border rounded-md text-[12px]">Lire la suite »</button></a>
                        </div>
            ...
            <div>
                    <div class="col-span-1 bg-[#efefef] h-min p-2 rounded-md box-shadow-type-1 border-b-2 border-[#9f9f9f] mb-5">
                            <h4 class="bg-[#3d72ab] p-1 w-full text-center text-white rounded-md">Wibbo du mois</h4>
                            <div class="flex items-center">
